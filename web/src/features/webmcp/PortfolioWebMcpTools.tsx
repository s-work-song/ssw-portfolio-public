...
> = {
  ...
  'control-portfolio-view': {
    ...
    description:
      '메인·홈 요청은 소개 Overview로 이동하고, 이력서, 자기소개서, 연구 경험의 연구 여정·성능 최적화·도구 & AI 접목 탭, 연구 연도, 기록 화면으로 이동합니다. 연구 여정의 전체 상세 또는 지정한 연도의 상세만 펼치거나 접을 수도 있습니다. 사용자가 화면 이동이나 연구 상세 제어를 명시적으로 요청했을 때 사용하세요.',
  },
