...
Next.js 정적 export로 만든 진입 페이지입니다. 이력·연구 정리·로그와 함께 RAG 챗봇
UI를 담고 있고, GitHub Pages로 배포합니다.

## 로컬 실행

의존성은 저장소 루트의 npm workspaces로 관리합니다.
...
`next.config.ts`의 `basePath`가 처리합니다.
